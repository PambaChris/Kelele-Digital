  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-2xl font-semibold text-foreground">Off the pitch</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Kelele Digital — A Nairobi media house" },
      {
        name: "description",
        content:
          "Kelele Digital is a Nairobi-based media house behind newsrooms, cultural coverage and digital marketing across Kenya and East Africa.",
      },
      { name: "author", content: "Kelele Digital" },
      { property: "og:title", content: "Kelele Digital — A Nairobi media house" },
      {
        property: "og:description",
        content:
          "News, culture and digital marketing — from Nairobi. Home of Battle Of The Fans and other stories.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Kelele Digital" },
